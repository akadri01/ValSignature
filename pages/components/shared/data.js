...
export const postedBySelectField = [
  { value: "", text: "Select posted by" },
  { value: "owner", text: "By owner" },
  { value: "agency", text: "By real estate agent" }
];
...
export const roomsSelectField = [
  ...
  { value: "10+3", text: "10+3" },
  { value: "10+4", text: "10+4" },
  { value: "10+5", text: "10+5" }
];

export const locationRegionSelectField = [
  { value: "", text: "Select region" },
  { value: "greater_Paris", text: "Greater Paris" },
  ...
  { value: "upper_east", text: "Upper East" },
  { value: "upper_west", text: "Upper West" },
  { value: "volta", text: "Volta" },
  { value: "brong_ahafo", text: "Brong Ahafo" }
];
